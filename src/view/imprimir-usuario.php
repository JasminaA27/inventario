...
curl_setopt_array($curl, array(
    CURLOPT_URL => BASE_URL_SERVER . "src/control/Usuario.php?tipo=listarUsuario&sesion=" . $_SESSION['sesion_id'] . "&token=" . $_SESSION['sesion_token'] ,
...
<p class="p"> PAPELETA DE LISTA DE USUARIO</p>
...
foreach ($usuarios as $usu) {
    ...
    $contenido_pdf .= "<td>{$usu->dni}</td>";
    $contenido_pdf .= "<td>{$usu->nombres_apellidos}</td>";
    $contenido_pdf .= "<td>{$usu->correo}</td>";
    $contenido_pdf .= "<td>{$usu->telefono}</td>";
    $contenido_pdf .= "<td>{$usu->estado}</td>";
    $contenido_pdf .= "<td>{$usu->fecha_registro}</td>";
    $contenido_pdf .= "</tr>";
    $contador++;
}
...
$pdf->SetTitle(' PAPELETA DE LISTA DE USUARIO');
