...
$curl = curl_init(); //inicia la sesión cURL
    curl_setopt_array($curl, array(
        CURLOPT_URL => BASE_URL_SERVER."src/control/Usuario.php?tipo=listarUsuario&sesion=".$_SESSION['sesion_id']."&token=".$_SESSION['sesion_token'], //url a la que se conecta
    ...
    if ($err) {
       ...
       // Crear el Excel
            ...
            $headers = [
                'ID', 'Dni', 'Nombres y apellidos', 'correo', 'telefono', 'estado', 'fecha registro'
             ];
