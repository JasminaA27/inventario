...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= BASE_URL ?>imprimir-usuario" class="btn btn-primary"><i class="fa fa-file-pdf"></i></a>
                 <a href="<?= BASE_URL ?>reporte-usuarios" class="btn btn-primary"><i class="fa fa-file-excel"></i></a>
